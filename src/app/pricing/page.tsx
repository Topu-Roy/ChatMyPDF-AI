  ...
  return (
    <>
      <MaxWidthWrapper className="mb-8 mt-24 max-w-5xl text-center">
        <div className="mb10\\ mx-auto sm:max-w-lg">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <p className="font-display py-5 text-6xl font-semibold">
                      ${price}
                    </p>
                  ...
                  <div className="flex h-20 items-center justify-center border-b border-t border-gray-200 bg-gray-50">
                    ...
                    <Tooltip delayDuration={200}>
                      <TooltipTrigger>
                        <HelpCircle className="ml-1.5 h-4 w-4 text-zinc-500" />
                      </TooltipTrigger>
                  ...
                  <ul className="my-10 space-y-5 px-8">
                    ...
                    <div className="p-5">
                      {plan === "Free" ? (
                        ...
                        <Link
                          href={
                            "/api/auth/login?post_login_redirect_url=/pricing"
                          }
                          className={buttonVariants({
